"function" != typeof Object.create && (Object.create = function (a) {
    ...
    var d = {
        init: function (b, c) {
            ...
            var a = this;
            a.$elem.data("owl-originalStyles", a.$elem.attr("style")), a.$elem.data("owl-originalClasses", a.$elem.attr("class")), a.$elem.css({opacity: 0}), a.orignalItems = a.options.items, a.checkBrowser(), a.wrapperWidth = 0, a.checkVisible = null, a.setVars()
        }, setVars: function () {
            var a = this;
            ...
            var f, g, h, i, a = this, d = "translate3d(0px, 0px, 0px)", e = c.createElement("div");
            ...
            var b = this, c = b.options.scrollPerPage === !0 ? b.pagesInArray : b.positionsInArray, d = b.newPosX,
                e = null;
            ...
            var e, c = this, d = a(c.$owlItems[c.currentItem]).find("img");
