            ...
            @foreach($services as $service)
                <div class="col-md-4">
                    <figure class="pic-hover hover-scale mb20">
                        ...
                        <img src="{{$service->image_link}}" style="width: 360px;height: 240px;" class="img-responsive"
                             alt="">
                    </figure>
                    <h3 style="height: 48px;font-weight: 600">{{$service->title}}</h3>
                    <p style="font-size: 16px; height: 61px">
                        {{$service->Brief}}
                        <br>
                    </p>
