            ...
            @foreach($services as $service)
                <div class="col-md-4">
                    <figure class="pic-hover hover-scale mb20">
                        ...
                        {{--                        <img src="{{$service->image_link}}" class="img-responsive" alt="">--}}
                    </figure>
                    <h3>{{$service->title}}</h3>
                    <p>
                        {{$service->description}}
                        <a href="#section-services-details" data-toggle="collapse" data-target="#collapse{{$service->id}}" class="read_more mt10" style="border: transparent;background: transparent;"
