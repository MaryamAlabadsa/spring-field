<section id="section-deco-3" class="text-light" data-stellar-background-ratio=".2">
    <div class="container">
        <div class="row">
                ...
                <div class="inner">
                    ...
                    <div class="text">
                        <h3 style=" text-align:justify !important; " >Spring Field is a design, engineering and project management consultancy that is dedicated
                            ...
                            we believe in enriching people's lives and the places they live through our innovative and
                            transformative work.</h3>
                    </div>
                </div>
            </div>
            <div class="feature-box-small-icon col-md-4 wow fadeIn" data-wow-delay="0">
